...
use defguard_proto::proxy::{
    ...
    ClientMfaStartRequest, ClientMfaTokenValidationRequest, CoreRequest, ExistingDevice,
    InstanceInfoRequest, MfaMethod, NewDevice, core_request, core_response,
};
...
use self::support::{
    ...
    send_activate_user, send_mfa_finish, send_mfa_start, send_token_validation, set_public_proxy_url,
