...
async fn main() -> Result<(), anyhow::Error> {
    ...
    tokio::select! {
        ...
        res = run_event_router( api_event_rx, grpc_event_rx, bidi_event_rx, internal_event_rx, event_logger_tx, wireguard_tx, mail_tx, audit_stream_reload_notify.clone()) => error!("Event router returned early: {res:?}"),
