...
impl DefGuardConfig {
    ...
    pub fn new_test_config() -> Self {
        ...
        let config = Self {
            ...
            cmd: None,
            check_period: std::time::Duration::from_hours(12).into(),
            check_period_no_license: std::time::Duration::from_hours(24).into(),
            check_period_renewal_window: std::time::Duration::from_hours(1).into(),
