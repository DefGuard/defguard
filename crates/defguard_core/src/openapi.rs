...
Errors are returned as a JSON object with a `msg` field and, for some of them, a machine-readable `code` field.",
    ...
    paths(
        ...
        acl::alias::bulk_delete_acl_aliases,
        ...
        acl::destination::bulk_delete_acl_destinations,
        ...
        acl::create_acl_rule,
        acl::apply_acl_rules,
        acl::bulk_enable_acl_rules,
        acl::bulk_disable_acl_rules,
        acl::bulk_delete_acl_rules,
        acl::count_acl_rules,
        acl::delete_acl_rule,
        acl::get_acl_rule,
        acl::update_acl_rule,
