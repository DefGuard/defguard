...
impl From<Settings> for SettingsNoSecrets {
    fn from(value: Settings) -> Self {
        Self {
            ...
            smtp_server: value.smtp.smtp_server,
            smtp_port: value.smtp.smtp_port,
            smtp_encryption: value.smtp.smtp_encryption,
            smtp_user: value.smtp.smtp_user,
            smtp_sender: value.smtp.smtp_sender,
