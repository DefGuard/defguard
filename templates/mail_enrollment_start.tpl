                  ...
                  <tr>
                    <td align="center" vertical-align="middle"
                      ...
                      <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                        ...
                        <tbody>
                          <tr>
                            <td align="center" bgcolor="#OC8CE0" role="presentation"
                              style="border:none;border-radius:10px;cursor:auto;height:50px;mso-padding-alt:10px 25px;background:#OC8CE0;"
                              valign="middle">
                              <a href="{{url}}"
                                style="display:inline-block;width:90px;background:#OC8CE0;color:#FFFFFF !important;font-family:Roboto;font-size:15px;font-weight:600;line-height:normal;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:10px;"
                  ...
                  <tr>
                    <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                      <div style="font-family:Roboto;font-size:12px;line-height:1;text-align:center;color:#899CA8;">
                        <p>If the provided button doesnt work, please copy & paste the following url in your browser:
                        </p>
