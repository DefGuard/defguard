        ...
        <tbody>
          <tr>
            <td style="direction:ltr;font-size:0px;padding:20px 0;text-align:center;">
              <!--[if mso | IE]><table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td class="" style="vertical-align:top;width:199.98px;" ><![endif]-->
                          ...
                          <tbody>
                            <tr>
                              <td style="width:110px;">
                                <img src="https://e.hypermatic.com/78a93c3a468ad5b3c0c52c99b11e3343.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="110" height="auto" />
                              </td>
                            </tr>
                          </tbody>
                        </table>
        ...
        <tbody>
          <tr>
            <td style="direction:ltr;font-size:0px;padding:0;text-align:center;">
                                    ...
                                    <tr>
                                      <td style="font-size:0;height:18px;vertical-align:middle;width:18px;">
                                        <a href="https://github.com/defguard/defguard" target="_blank">
                                          <img alt="github-logo" height="18" src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c2/GitHub_Invertocat_Logo.svg/450px-GitHub_Invertocat_Logo.svg.png?20230417032619" style="border-radius:3px;display:block;" width="18" />
                                        </a>
                                      </td>
                                    </tr>
                                  </tbody>
                              ...
                              <td style="padding:4px;vertical-align:middle;">
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-radius:3px;width:18px;">
                                  <tbody>
                                    <tr>
                                      <td style="font-size:0;height:18px;vertical-align:middle;width:18px;">
                                        <a href="https://twitter.com/defguard_net" target="_blank">
                                          <img alt="twitter-logo" height="18" src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/Twitter_bird_logo_black.svg/640px-Twitter_bird_logo_black.svg.png" style="border-radius:3px;display:block;" width="18" />
                                        </a>
                                      </td>
                                    </tr>
                                  </tbody>
                                    ...
                                    <tr>
                                      <td style="font-size:0;height:18px;vertical-align:middle;width:18px;">
                                        <a href="https://matrix.to/#/#defguard:teonite.com" target="_blank">
                                          <img alt="matrix-logo" height="18" src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/Matrix_icon.svg/768px-Matrix_icon.svg.png?20210502154855" style="border-radius:3px;display:block;" width="18" />
                                        </a>
                                      </td>
                                    </tr>
                                  </tbody>
                              ...
                              <td style="padding:4px;vertical-align:middle;">
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-radius:3px;width:18px;">
                                  <tbody>
                                    <tr>
                                      <td style="font-size:0;height:18px;vertical-align:middle;width:18px;">
                                        <a href="https://floss.social/@defguard" target="_blank">
                                          <img alt="mastodon-logo" height="18" src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Font_Awesome_5_brands_mastodon.svg/640px-Font_Awesome_5_brands_mastodon.svg.png" style="border-radius:3px;display:block;" width="18" />
                                        </a>
                                      </td>
                                    </tr>
                                  </tbody>
              ...
              <!--[if mso | IE]></td><td class="" style="" ><table align="center" border="0" cellpadding="0" cellspacing="0" class="" role="presentation" style="width:600px;" width="600" bgcolor="#f9f9f9" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><![endif]-->
              <div style="background:#f9f9f9;background-color:#f9f9f9;margin:0px auto;max-width:600px;">
                <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:#f9f9f9;background-color:#f9f9f9;width:100%;">
                  <tbody>
                    <tr>
