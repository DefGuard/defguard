...
<body lang="en" link="#DD0000" vlink="#DD0000" class="emailify"
  style="mso-line-height-rule:exactly;mso-hyphenate:none;word-spacing:normal;background-color:#3d3d3d;">
  <div
  ...
  <div class="bg" style="background-color:#3d3d3d;" lang="en">
    <!--[if mso | IE]>
...
<![endif]-->
              <div class="xc568 ogf c"
                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                  ...
                  <tbody>
                    <tr>
                      <td align="center" class="c" style="font-size:0;padding:0;word-break:break-word;">
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                          style="border-collapse:collapse;border-spacing:0;">
                          <tbody>
                            <tr>
                              <td style="width:110px;"> <img alt
                                  src="https://e.hypermatic.com/78a93c3a468ad5b3c0c52c99b11e3343.png"
                                  style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;"
                                  title width="110" height="auto">
                              </td>
                            </tr>
                          </tbody>
                        </table>
...
<![endif]-->
    <div class="r  pr-16 pl-16" style="background:#f9f9f9;background-color:#f9f9f9;margin:0px auto;max-width:600px;">
      <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
        ...
        <tbody>
          <tr>
            <td style="border:none;direction:ltr;font-size:0;padding:20px 105px 20px 105px;text-align:left;">
              <!--[if mso | IE]>
<table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td class="c-outlook -outlook -outlook" style="vertical-align:middle;width:390px;">
<![endif]-->
              <div class="xc390 ogf c"
                style="font-size:0;text-align:left;direction:ltr;display:inline-block;vertical-align:middle;width:100%;">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                  style="border:none;vertical-align:middle;" width="100%">
                  <tbody>
                    <tr>
                      <td align="center" class="c" style="font-size:0;padding:0;word-break:break-word;">
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                          ...
                          <tbody>
                            <tr>
                              <td style="width:170px;"> <img alt
                                  src="https://e.hypermatic.com/9425bfe4afccb24ae6da74deca32c3b9.png"
                                  style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;"
                                  title width="170" height="auto">
                              </td>
                            </tr>
                          </tbody>
                        </table>
