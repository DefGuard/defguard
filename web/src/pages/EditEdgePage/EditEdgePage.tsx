      ...
      <form.AppForm>
        <EditPageFormSection label={m.edge_edit_general_info()}>
          <form.AppField name="name">
            {(field) => <field.FormInput required label="edge_edit_name" />}
          </form.AppField>
          <SizedBox height={ThemeSpacing.Xl2} />
          <form.AppField name="address">
            {(field) => <field.FormInput disabled label="edge_edit_address" />}
          </form.AppField>
          <SizedBox height={ThemeSpacing.Xl2} />
          <form.AppField name="port">
            {(field) => <field.FormInput disabled label="edge_edit_port" />}
          </form.AppField>
          <SizedBox height={ThemeSpacing.Xl2} />
