...
import type { OpenDeleteNetworkDeviceModal } from '../../../../shared/hooks/modalControls/types';

const modalNameValue = ModalName.DeleteNetworkDevice;

type ModalData = OpenDeleteNetworkDeviceModal;

export const DeleteNetworkDeviceModal = () => {
  ...
  return (
    <Modal
      id="delete-network-device-modal"
      size="small"
    ...
    >
      <AppText font={TextStyle.TBodySm400}>
        {m.modal_delete_network_device_body()}
      </AppText>
      <ModalControls
        submitProps={{
          text: m.controls_delete(),
          variant: 'critical',
          testId: 'delete-network-device-confirm',
