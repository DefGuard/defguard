        ...
        <form.AppForm>
          ...
          <EvenSplit parts={2}>
            <form.AppField name="username">
              {(field) => <field.FormInput required label="form_label_username" />}
            </form.AppField>
            <form.AppField name="email">
              {(field) => <field.FormInput required label="form_label_email" />}
            </form.AppField>
          </EvenSplit>
          ...
          <EvenSplit>
            <form.AppField name="first_name">
              {(field) => <field.FormInput required label="form_label_first_name" />}
            </form.AppField>
            <form.AppField name="last_name">
              {(field) => <field.FormInput required label="form_label_last_name" />}
            </form.AppField>
          </EvenSplit>
