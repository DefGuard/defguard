  ...
  userPage: {
    ...
    userDetails: {
      ...
      warningModals: {
        title: 'Warning',
        content: {
          usernameChange: `Changing a user's username has a significant impact on services they have logged into using Defguard. After changing the username, the user may lose access to applications (since they will not recognize them). Are you sure you want to proceed?`,
