...
const modalNameKey = ModalName.UpgradeBusiness;

export const UpgradeBusinessModal = () => {
  ...
  return (
    <LicenseModal
      id="upgrade-business-modal"
      isOpen={isOpen}
      onClose={() => setOpen(false)}
      afterClose={() => {}}
      image={<LicenseModalSideImage variant="business" />}
      lines
    >
      <ModalContent />
    </LicenseModal>
