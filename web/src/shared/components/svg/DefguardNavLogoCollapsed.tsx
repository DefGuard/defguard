...
const SvgDefguardNavLogoCollapsed = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#defguard-nav-logo-collapsed_svg__a)">
      <path
        fill="#0C8CE0"
    ...
    <defs>
      <clipPath id="defguard-nav-logo-collapsed_svg__a">
        <path fill="#fff" d="M0 0h21v43H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgDefguardNavLogoCollapsed;
