  ...
  <svg xmlns="http://www.w3.org/2000/svg" width={22} height={22} {...props}>
    <defs>
      <clipPath id="icon-hourglass-hover_svg__a">
        <path className="icon-hourglass-hover_svg__a" d="M0 0h22v22H0z" />
      </clipPath>
      <style>
        {
          '\n      .icon-hourglass-hover_svg__a,.icon-hourglass-hover_svg__c{fill:#0c8ce0}.icon-hourglass-hover_svg__a{opacity:0}.icon-hourglass-hover_svg__b{clip-path:url(#icon-hourglass-hover_svg__a)}\n    '
        }
      </style>
    </defs>
    <g className="icon-hourglass-hover_svg__b">
      <path
