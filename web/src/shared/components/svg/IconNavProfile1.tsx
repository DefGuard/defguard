...
const SvgIconNavProfile1 = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      <style>{'.icon-nav-profile-1_svg__b{fill:#0c8ce0}'}</style>
    </defs>
    <path
      ...
      className="icon-nav-profile-1_svg__b"
    />
  </svg>
);
export default SvgIconNavProfile1;
