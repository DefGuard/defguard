...
const SvgIconEdit = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={22} height={22} {...props}>
    <defs>
      ...
      <style>
        {
          '\n      .icon-edit_svg__a,.icon-edit_svg__c{fill:#899ca8}.icon-edit_svg__a{opacity:0}\n    '
        }
      </style>
    </defs>
    <g className="icon-edit_svg__b">
      <path
        className="icon-edit_svg__c"
