  ...
  <svg xmlns="http://www.w3.org/2000/svg" width={22} height={22} {...props}>
    <defs>
      <clipPath id="icon-waiting-hover_svg__a">
        <path className="icon-waiting-hover_svg__a" d="M0 0h22v22H0z" />
      </clipPath>
      <style>
        {
          '\n      .icon-waiting-hover_svg__a,.icon-waiting-hover_svg__c{fill:#0c8ce0}.icon-waiting-hover_svg__a{opacity:0}.icon-waiting-hover_svg__b{clip-path:url(#icon-waiting-hover_svg__a)}\n    '
        }
      </style>
    </defs>
    <g className="icon-waiting-hover_svg__b">
      <path
