export const QueryKeys = {
  ...
  FETCH_ACL_CREATE_CONTEXT: 'FETCH_ACL_CREATE_CONTEXT',
  FETCH_ACL_RULES: 'FETCH_ACL_RULES',
  FETCH_ACL_ALIASES: 'FETCH_ACL_ALIASES',
  FETCH_ACL_RULE_EDIT: 'FETCH_ACL_RULE_EDIT',
};
