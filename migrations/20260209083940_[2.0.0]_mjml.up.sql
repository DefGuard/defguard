...
INSERT INTO mail_context (template, section, language_tag, text) VALUES
    ...
    ('new-account', 'scan_qr', 'en_US', 'Scan QR code bellow to activate Defguard mobile application.'),
    ('new-account', 'mobile_install', 'en_US', 'If you haven''t installed the mobile app, click one of the buttons bellow.'),
