...
use sqlx::{
    Error as SqlxError, FromRow, PgConnection, PgExecutor, PgPool, Type, postgres::types::PgRange,
...
pub fn parse_destination_addresses(destination: &str) -> Result<ParsedDestination, AclError> {
...
impl AclRule<Id> {
    ...
    pub async fn delete_related_objects(
        &self,
...
impl AclRule<Id> {
    ...
    pub async fn get_aliases<'e, E>(&self, executor: E) -> Result<Vec<AclAlias<Id>>, SqlxError>
    where
        E: PgExecutor<'e>,
    {
        query_as!(
    ...
    pub async fn get_allowed_users<'e, E>(&self, executor: E) -> Result<Vec<User<Id>>, SqlxError>
    where
        E: PgExecutor<'e>,
    {
        query_as!(
    ...
    pub async fn get_denied_users<'e, E>(&self, executor: E) -> Result<Vec<User<Id>>, SqlxError>
    where
        E: PgExecutor<'e>,
    {
        query_as!(
    ...
    pub async fn get_network_devices<'e, E>(
        &self,
        executor: E,
        allowed: bool,
    ...
    pub async fn get_allowed_network_devices<'e, E>(
        &self,
        executor: E,
    ) -> Result<Vec<Device<Id>>, SqlxError>
    where
    ...
    pub async fn get_denied_network_devices<'e, E>(
        &self,
        executor: E,
    ) -> Result<Vec<Device<Id>>, SqlxError>
    where
    ...
    pub async fn get_destination_address_ranges<'e, E>(
        &self,
        executor: E,
...
impl AclRuleInfo<Id> {
    ...
    pub async fn get_all_allowed_users(
        &self,
    ...
    pub async fn get_all_denied_users(
        &self,
        conn: &mut PgConnection,
    ) -> Result<Vec<User<Id>>, SqlxError> {
        debug!(
    ...
    pub async fn get_all_allowed_devices<'e, E: sqlx::PgExecutor<'e>>(
        &self,
        executor: E,
        location_id: Id,
    ) -> Result<Vec<Device<Id>>, SqlxError> {
    ...
    pub async fn get_all_denied_devices<'e, E: sqlx::PgExecutor<'e>>(
        &self,
        executor: E,
        location_id: Id,
    ) -> Result<Vec<Device<Id>>, SqlxError> {
...
pub async fn acl_delete_related_objects(
    transaction: &mut PgConnection,
    alias_id: Id,
) -> Result<(), AclError> {
...
impl AclAlias<Id> {
    ...
    pub async fn get_destination_ranges<'e, E>(
        &self,
        executor: E,
    ...
    pub async fn get_rules<'e, E>(&self, executor: E) -> Result<Vec<AclRule<Id>>, SqlxError>
    where
        E: PgExecutor<'e>,
    {
        query_as!(
    ...
    pub async fn to_info(&self, pool: &PgPool) -> Result<AclAliasInfo, SqlxError> {
...
impl AclRuleGroup {
    #[must_use]
    pub fn new(rule_id: Id, group_id: Id, allow: bool) -> Self {
        Self {
            id: NoId,
            rule_id,
            group_id,
...
impl AclRuleAlias {
    #[must_use]
    pub fn new(rule_id: Id, alias_id: Id) -> Self {
        Self {
            id: NoId,
            rule_id,
            alias_id,
...
impl AclRuleDevice {
    #[must_use]
    pub fn new(rule_id: Id, device_id: Id, allow: bool) -> Self {
        Self {
            id: NoId,
            rule_id,
            device_id,
